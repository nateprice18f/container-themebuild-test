...
COPY --chown=node:node ${{ github.workspace }}/compose-theme/www/web/themes /var/www/web/themes/
COPY --chown=node:node ${{ github.workspace }}/compose-theme/www/web/libraries/ /var/www/web/libraries/
