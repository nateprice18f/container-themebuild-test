...
class CkeditorUswdsAccordion extends CKEditorPluginBase {
  ...
  public function getFile() {
    return $this->getModulePath('uswds_ckeditor_integration') . '/js/plugins/uswds_accordion/plugin.js';
  }
  ...
  public function getButtons() {
    $path = $this->getModulePath('uswds_ckeditor_integration') . '/js/plugins/uswds_accordion/icons';
    return [
      'Accordion' => [
        'label' => 'Add Accordion',
