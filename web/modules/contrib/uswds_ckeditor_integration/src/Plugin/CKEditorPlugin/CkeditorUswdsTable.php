...
class CkeditorUswdsTable extends CKEditorPluginBase implements CKEditorPluginInterface, CKEditorPluginContextualInterface, CKEditorPluginConfigurableInterface {
  ...
  public function getPluginPath() {
    return $this->getModulePath('uswds_ckeditor_integration') . '/js/plugins/uswds_table';
  }
  ...
  public function isEnabled(Editor $editor) {
    ...
    $checked = $settings['plugins']['uswds_table']['override_table'] ?? FALSE;
  ...
  public function settingsForm(array $form, FormStateInterface $form_state, Editor $editor) {
    ...
    $form['override_table'] = [
      ...
      '#type' => 'checkbox',
      '#default_value' => $settings['plugins']['uswds_table']['override_table'] ?? '',
