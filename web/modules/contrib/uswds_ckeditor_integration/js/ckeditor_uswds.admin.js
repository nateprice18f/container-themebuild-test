  ...
  Drupal.behaviors.ckeditorTemplatesSettingsSummary = {
    attach: function () {
      $('[data-ckeditor-plugin-id="uswds_table"]').drupalSetSummary(function (context) {
        let replaceContentValue = $('input[name="editor[settings][plugins][uswds_table][override_table]').is(':checked');

        return replaceContentValue ? '"Use USWDS Table:" checked' : '"Use USWDS Table:" unchecked';
      });
    }
  };
